...
The MediaPipe library was used for hand detection and tracking. Ethical issues to consider when using MediaPipe primarily include issues surrounding data privacy, surveillance, bias, and discrimination.
